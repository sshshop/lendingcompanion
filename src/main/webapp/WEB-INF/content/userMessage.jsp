...
<div style="width:80%;margin-top: 30px;align-content: center;">
    ...
    <div class="tab-content" >
        <div class="tab-pane fade in active " style="padding-top: 30px;letter-spacing: 2px;align-content: center; " id="usermessage">
          ...
          <div class="tab-content">
                    <%--用户资料界面--%>
                    <div class="tab-pane fade in active " id="bcontent" style="font-size: 15px;margin-top: 20px; margin-left: 35%">
