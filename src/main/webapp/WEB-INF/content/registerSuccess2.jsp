...
<div class="container context">
    <div class="row">
        ...
        <div class="col-md-6">
            <!--注册表单-->
            <div >
                <label style="margin-left: 39%"  ><img src="image/jihuo.png" height="100px"></label><br>
            ...
            <div class="context_form" style="background-color:rgba(112,128,144,0.8);">
                ...
                <form class="form-horizontal register"  >
                    ...
                    <div class="form-group " style="text-align: center">
                        ...
                        <label class="control-label " ><img src="image/tishi2.png;" height="27px">&nbsp;激活成功，请牢记您的账户信息</label>
